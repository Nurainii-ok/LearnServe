        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ session('role') === 'admin' ? route('admin.video-contents.index') : route('tutor.video-contents.index') }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ session('role') === 'admin' ? route('admin.video-contents.update', $videoContent) : route('tutor.video-contents.update', $videoContent) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" 
                                           value="{{ old('title', $videoContent->title) }}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="description" class="form-label">Description</label>
                                    <textarea class="form-control" id="description" name="description" rows="4">{{ old('description', $videoContent->description) }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="video_url" class="form-label">Video URL <span class="text-danger">*</span></label>
                                    <input type="url" class="form-control" id="video_url" name="video_url" 
                                           value="{{ old('video_url', $videoContent->video_url) }}" required 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="duration" name="duration" 
                                                   value="{{ old('duration', $videoContent->duration) }}" min="1" placeholder="e.g., 300 for 5 minutes">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="order" name="order" 
                                                   value="{{ old('order', $videoContent->order) }}" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Max size: 2MB. Formats: JPEG, PNG, JPG, GIF. Leave empty to keep current.</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="course_type" id="course_type_class" 
                                               value="class" {{ old('course_type', $videoContent->class_id ? 'class' : '') === 'class' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="course_type" id="course_type_bootcamp" 
                                               value="bootcamp" {{ old('course_type', $videoContent->bootcamp_id ? 'bootcamp' : '') === 'bootcamp' ? 'checked' : '' }}>
                                ...
                                <div class="mb-3" id="class_select" style="display: none;">
                                    ...
                                    <select class="form-select" id="class_id" name="class_id">
                                        ...
                                        @foreach($classes as $class)
                                            <option value="{{ $class->id }}" {{ old('class_id', $videoContent->class_id) == $class->id ? 'selected' : '' }}>
                                                {{ $class->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3" id="bootcamp_select" style="display: none;">
                                    ...
                                    <select class="form-select" id="bootcamp_id" name="bootcamp_id">
                                        ...
                                        @foreach($bootcamps as $bootcamp)
                                            <option value="{{ $bootcamp->id }}" {{ old('bootcamp_id', $videoContent->bootcamp_id) == $bootcamp->id ? 'selected' : '' }}>
                                                {{ $bootcamp->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="active" {{ old('status', $videoContent->status) === 'active' ? 'selected' : '' }}>Active</option>
                                        <option value="inactive" {{ old('status', $videoContent->status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ session('role') === 'admin' ? route('admin.video-contents.index') : route('tutor.video-contents.index') }}" class="btn btn-secondary">Cancel</a>
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-save"></i> Update Video Content
                            </button>
                        </div>
                    </form>
                </div>
