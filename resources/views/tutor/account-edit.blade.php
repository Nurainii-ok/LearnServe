...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('tutor.account') }}" style="color: #944e25;">Account Settings</a></li>
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4 shadow-sm" style="border-color: #ecac57; border-width: 2px;">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('tutor.account.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">
                                        <i class="fas fa-chalkboard-teacher me-1" style="color: #944e25;"></i>
                                        Role
                                    </label>
                                    <input type="text" class="form-control" value="Tutor" readonly 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $tutor->created_at->format('M d, Y') }}" readonly 
                                           style="background-color: #f8f9fa; border-color: #e9ecef;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3">
                            <a href="{{ route('tutor.account') }}" class="btn btn-outline-secondary">
