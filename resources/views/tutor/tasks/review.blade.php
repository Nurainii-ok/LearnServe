                    ...
                    <div class="row">
                                ...
                                @if($submission->file_path)
                                    <div class="card bg-light mb-3">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ asset('storage/' . $submission->file_path) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('tutor.tasks.submission.submit-review', $submission->id) }}" method="POST">
                                        @csrf
