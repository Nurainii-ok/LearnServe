        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">My Video Contents</h5>
                    <a href="{{ route('tutor.video-contents.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('tutor.video-contents.show', $video) }}">
                                                        <i class="bx bx-show me-1"></i> View
                                                    </a>
                                                    <a class="dropdown-item" href="{{ route('tutor.video-contents.edit', $video) }}">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit
                                                    </a>
                                                    <form action="{{ route('tutor.video-contents.destroy', $video) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Start by creating your first video content for your classes.</p>
                            <a href="{{ route('tutor.video-contents.create') }}" class="btn btn-primary">
                                <i class="bx bx-plus"></i> Add Video Content
                            </a>
                        </div>
